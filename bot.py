...
if __name__ == '__main__':
  ...
  application.add_handler(MessageHandler(filters.TEXT & (~filters.COMMAND), handle_general_message), group=100)
  application.add_handler(MessageHandler(filters.TEXT & (~filters.COMMAND), handle_permission_check), group=1)
